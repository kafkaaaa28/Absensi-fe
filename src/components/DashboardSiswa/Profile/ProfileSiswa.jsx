...
import { FaEnvelope, FaGraduationCap, FaCalendarAlt, FaUniversity } from 'react-icons/fa';
    ...
    <div className="max-w-2xl mx-auto bg-white shadow-lg rounded-lg p-6 my-10">
      ...
      <div className="mt-6 space-y-4">
        <div className="flex items-center gap-4">
          ...
          <p className="text-gray-700">{siswa.email}</p>
        </div>
        <div className="flex items-center gap-4">
          <FaUniversity className="text-[#162542]" />
          <p className="text-gray-700">{siswa.fakultas}</p>
        </div>
        <div className="flex items-center gap-4">
          <FaGraduationCap className="text-[#162542]" />
          <p className="text-gray-700">{siswa.prodi}</p>
        </div>
        <div className="flex items-center gap-4">
          ...
          <p className="text-gray-700">
            Anda Terdaftar Pada{' '}
            {siswa.created_at
              ? new Date(siswa.created_at).toLocaleString('id-ID', {
                  day: '2-digit',
                  month: 'long',
                  year: 'numeric',
                  hour: '2-digit',
